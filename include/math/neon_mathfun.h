#ifndef MATH_NEON_MATHFUN_H
#define MATH_NEON_MATHFUN_H

#if defined(__ARM_NEON__)

#include <arm_neon.h>

namespace dlfm::math::neon {
...
v4sf sigmoid_ps(v4sf x) {
  ...
  v4sf out = vrecpeq_f32(p);

  return vmulq_f32(vrecpsq_f32(p, out), out);
}

float32x4_t sqrt_ps(float32x4_t q_x) {
